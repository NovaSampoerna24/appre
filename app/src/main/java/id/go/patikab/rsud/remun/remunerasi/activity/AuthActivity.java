...
import id.go.patikab.rsud.remun.remunerasi.config.api.ApiClient;
import id.go.patikab.rsud.remun.remunerasi.config.api.ApiInterface;
import id.go.patikab.rsud.remun.remunerasi.config.database.DatabaseHandler;
...
import id.go.patikab.rsud.remun.remunerasi.config.page_dialog.CustomDialogDetail;
import retrofit2.Call;
import retrofit2.Callback;
import retrofit2.Response;

import static id.go.patikab.rsud.remun.remunerasi.config.database.sharepreference.SharePref.login_session;
import static id.go.patikab.rsud.remun.remunerasi.config.database.sharepreference.SharePref.my_token;
import static id.go.patikab.rsud.remun.remunerasi.config.database.sharepreference.SharePref.nm_dokter;
